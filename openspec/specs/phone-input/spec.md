...
Capture telephone numbers with an explicitly chosen country dial code, store the code apart from the national number, and do it through one shared component wherever the marketplace asks for a phone.
