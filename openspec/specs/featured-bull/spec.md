...
Let a seller spotlight one of their approved bulls on the marketplace home page, with the "one per seller" and "only once approved" rules enforced in the database, and define the card that publishes it.
